...
var bullets = {
	...
	update: function(){
		for(i = 0; i < this.projectiles.length; i++){
			...
			if (block.hp > 0 && circlePoint({x: block.x + block.hurtCircle.x, y: block.y + block.hurtCircle.y, r: block.hurtCircle.r}, {x: this.projectiles[i].x + 5, y: this.projectiles[i].y + 5})){
				block.colour.g = 0.0;
				block.colour.r = 1.0;
