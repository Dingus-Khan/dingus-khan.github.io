...
class Player extends Animation {
	constructor(tex){
		...
		this.addAnimation("attack_down", 0, 4, 4, 5, 32, 32, false, 32, 32);
		this.addAnimation("attack_up", 0, 4, 5, 5, 32, 32, false, 32, 32);
		this.addAnimation("attack_right", 0, 4, 6, 5, 32, 32, false, 32, 32);
		this.addAnimation("attack_left", 0, 4, 7, 5, 32, 32, false, 32, 32);
