...
class Player extends Animation {
	constructor(tex){
		...
		this.addAnimation("attack_down", 0, 4, 4, 6, 32, 32, false, 32, 32);
		this.addAnimation("attack_up", 0, 4, 5, 6, 32, 32, false, 32, 32);
		this.addAnimation("attack_right", 0, 4, 6, 6, 32, 32, false, 32, 32);
		this.addAnimation("attack_left", 0, 4, 7, 6, 32, 32, false, 32, 32);
